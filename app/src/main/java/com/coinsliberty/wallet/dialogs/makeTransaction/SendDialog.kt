...
import com.coinsliberty.wallet.databinding.BottomSheetMakeTransferCopyBinding
...
class SendDialog : BottomSheetDialogFragment() {
    ...
    private lateinit var currency: com.coinsliberty.wallet.utils.currency.Currency
