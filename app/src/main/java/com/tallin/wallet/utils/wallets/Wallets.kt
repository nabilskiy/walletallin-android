package com.tallin.wallet.utils.wallets
...
enum class Wallets : Parcelable {
    ...
    ETHEREUM_WALLET {
        ...
        override fun getFeeCoefficient(): Double = 21000 * 10E-9

    },
    TETHER_WALLET {
        override fun getImg(): Int = R.drawable.ic_tether_logo

        override fun getBackground(): Int = R.drawable.bg_wallet_item_light_green

        override fun getTitle(): String = "Tether ERC20"

        override fun getColor(): Int =
            Color.parseColor("#00A579")

        override fun getFeeCoefficient(): Double = 48000 * 10E-9
    },
    LITECOIN_WALLET {
